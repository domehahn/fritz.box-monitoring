...
def test_collector_service_collect_once():
    ...
    mock_client.get_wan_stats_typed.return_value = WanStats(total_bytes_received=1000, total_bytes_sent=500)
    mock_client.router_client.get_dsl_stats.return_value = DslStats(downstream_attenuation=10.0)
